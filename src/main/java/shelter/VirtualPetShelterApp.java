...
public class VirtualPetShelterAPP {
    ...
    public static void main(String[] args) {
        ...
        VirtualPetShelter adoptablePets = new VirtualPetShelter();
        adoptablePets.intake(new VirtualPet("Ollie", "A Siamese Cat", 10, 10, 10, 10));
        adoptablePets.intake(new VirtualPet("Jelly", "A Persian Cat", 10, 10, 10, 10));
        adoptablePets.intake(new VirtualPet("Schnitzel", "A fat calico", 10, 10, 10, 10));
        adoptablePets.intake(new VirtualPet("Rufus", "A weird dog.", 10, 10, 10, 10));
        adoptablePets.intake(new VirtualPet("Professor", "A good pug", 10, 10, 10, 10));
        adoptablePets.intake(new VirtualPet("Stitch", "He's blue", 10, 10, 10, 10));
        ...
        while (true) {
            ...
            if (menuOption.equalsIgnoreCase("help")) {
                ...
                adoptablePets.intake(new VirtualPet(intakePetName, intakePetDescription, 10, 10, 10, 10));
                showPetStatuses(adoptablePets);
    ...
    public static void showPetStatuses(VirtualPetShelter adoptablePets) {
